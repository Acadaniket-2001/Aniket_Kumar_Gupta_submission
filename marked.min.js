...
!(function (e, t) {
                    ...
                    if ("blockquote" === h?.type) {
                        ...
                        (r[r.length - 1] = l),
                            (n =
                                ...
                                l.raw),
                            (s =
                                s.substring(0, s.length - t.text.length) +
                                l.text);
                        break;
                    }
                    if ("list" !== h?.type);
                        ...
                        (r[r.length - 1] = l),
                            (n =
                                ...
                                l.raw),
                            (s =
                                s.substring(0, s.length - t.raw.length) +
                                l.raw),
                ...
                for (; e; ) {
                    ...
                    if (
                        ...
                        for (; e; ) {
                            ...
                            if (n.test(c)) break;
                            if (
                                g.search(this.rules.other.nonSpaceChar) >= p ||
                                !c.trim()
                            )
                                o += "\n" + g.slice(p);
                            else {
                    ...
                    r.loose ||
                        (l
                            ? (r.loose = !0)
                            : this.rules.other.doubleBlankLine.test(s) &&
                              (l = !0));
                    let u,
                        g = null;
                    this.options.gfm &&
    ...
    class W {
        ...
        inlineTokens(e, t = []) {
            ...
            if (this.tokens.links) {
                ...
                if (e.length > 0)
                    for (
                        ;
                        null !=
                        (s = this.tokenizer.rules.inline.reflinkSearch.exec(n));
            ...
            for (
                ;
                null != (s = this.tokenizer.rules.inline.blockSkip.exec(n));
            ...
            for (
                ;
                null !=
                (s = this.tokenizer.rules.inline.anyPunctuation.exec(n));
            ...
            return (
                e.forEach((e) => {
                    ...
                    if (
                        ...
                        const t =
                            this.defaults.renderer || new Y(this.defaults);
                    ...
                    if (e.tokenizer) {
                        const t =
                            this.defaults.tokenizer || new V(this.defaults);
            ...
            return (t, n) => {
                ...
                if (r.async)
                    return Promise.resolve(r.hooks ? r.hooks.preprocess(t) : t)
                        .then((e) => l(e, r))
                        .then((e) =>
                            r.hooks ? r.hooks.processAllTokens(e) : e
                        )
                        .then((e) =>
                            r.walkTokens
                                ? Promise.all(
                                      this.walkTokens(e, r.walkTokens)
                                  ).then(() => e)
                                : e
                        )
                        .then((e) => o(e, r))
    ...
    (ie.options = ie.setOptions =
        ...
        (ie.use = function (...e) {
            return (
                re.use(...e), (ie.defaults = re.defaults), n(ie.defaults), ie
            );
        }),
